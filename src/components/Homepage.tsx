...
interface HomepageProps {
  onItemClick: (category: string, post: Post) => void;
}

export function Homepage({ onItemClick }: HomepageProps) {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <Navbar activeTab="home" onTabChange={(tab) => {
        if (tab !== 'home') {
          const firstPost = allPosts.find(p => p.category === tab);
          if (firstPost) {
            onItemClick(tab, firstPost);
          }
        }
      }} />
            ...
            >
              {allPosts.map((post, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      onClick={() => onItemClick(post.category || 'arts', post)}
